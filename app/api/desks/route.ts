    ...
    if (mapStyle) {
      await tx.mapConfig.update({
        ...
        data: {
          ...
          brandLogoUrl: typeof mapStyle.brandLogoUrl === "string" ? mapStyle.brandLogoUrl : undefined,
          brandTitle: typeof mapStyle.brandTitle === "string" ? mapStyle.brandTitle : undefined,
          brandSubtitle: typeof mapStyle.brandSubtitle === "string" ? mapStyle.brandSubtitle : undefined,
